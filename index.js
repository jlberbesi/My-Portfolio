...
projectData.forEach((item) => {
  item.seeProjectBtn.addEventListener('click', () => {
    ...
    popUpWindow.children[0].children[1].innerHTML = item.name;
    popUpWindow.children[0].children[5].children[0].innerHTML = item.description;
    popUpWindow.children[0].children[5].children[1].innerHTML = item.description;
    popUpWindow.children[0].children[3].appendChild(item.image);
    item.image.setAttribute('src', item.image_src);
    popUpWindow.children[0].children[4].children[0].appendChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[1].appendChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[2].appendChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[3].appendChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[2].children[0].children[0].innerHTML = item.list1;
    popUpWindow.children[0].children[2].children[1].children[0].innerHTML = item.list2;
    popUpWindow.children[0].children[2].children[2].children[0].innerHTML = item.list3;
  ...
  popupCloseBtn.addEventListener('click', () => {
    popUpWindow.children[0].children[3].removeChild(item.image);
    popUpWindow.classList.toggle('popup-window-active');
    body.children[1].style.display = 'block';
    popUpWindow.children[0].children[4].children[0].removeChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[1].removeChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[2].removeChild(item.image.cloneNode(true));
    popUpWindow.children[0].children[4].children[3].removeChild(item.image.cloneNode(true));
  });
});
